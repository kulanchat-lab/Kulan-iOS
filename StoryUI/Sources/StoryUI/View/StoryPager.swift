    ...
    final class Coordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIGestureRecognizerDelegate {
        ...
        @objc func handleDismiss(_ g: UIPanGestureRecognizer) {
            ...
            case .changed:
                ...
                // Move the whole card down; the clear cover behind reveals the CHAT LIST above (WhatsApp),
                // not a blurred snapshot (that snapshot's dark header read as a "black bar" at the top).
